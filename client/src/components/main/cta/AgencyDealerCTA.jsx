  ...
  return (
    <div className="flex flex-wrap gap-3">
      ...
      <button
        ...
        className={`group relative ${basePadding} bg-gradient-to-r from-blue-500/60 text-white font-semibold rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-blue-500/70`}
      >
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-blue-500 to-cyan-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
      </button>
    </div>
  );
};
