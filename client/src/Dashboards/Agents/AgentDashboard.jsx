...
function DashboardLayout() {
  ...
  return (
    ...
    >
      ...
      {/* Sidebar */}
      <div
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 rounded-tr-xl rounded-br-xl md:rounded-tr-none h-full flex flex-col shadow-xl transform transition-transform duration-300 ease-in-out ${
